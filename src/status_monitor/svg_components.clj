...
(def cider-logo
  ...
  C243.735,186.686,234.054,213.526,205.455,225.406z"}]
   ...
   ;; The main part of the glass
   [:g

    ;; This path is not quite right
    [:path {:stroke-width 12
            :stroke       "Black"
            :fill         "White"
            :d            "M32.78,253.24h-20.68C5.06,253.24,0,248.401,0,241.8V11.44C0,5.06,5.06,0,12.101,0h20.68
;;     c5.72,0,10.34,4.62,10.34,10.34c0,5.72-4.62,10.34-10.34,10.34H23.76v211.88h9.021c5.72,0,10.34,4.621,10.34,10.341
;;     S38.5,253.24,32.78,253.24z"}]
    [:path {:stroke-width 12
            :stroke       "Black"
